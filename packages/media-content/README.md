...
To load your pages faster, a clickable and responsibe thumbnail for the is embedded (when no `autoplay` setting is provided or it is set to `false`). Upon clicking, it loads the iframe and play the video.
